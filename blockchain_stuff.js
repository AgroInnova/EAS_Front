...
const createServiceAttestation = async (userId,equipmentId, activatioDays) =>{
    const result = await my_contract.methods.createServiceAttestation(userId,equipmentId, activatioDays)
